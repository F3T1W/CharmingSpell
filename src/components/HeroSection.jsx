    ...
    return (
        ...
        >
          <div
            style={{
              clipPath:
                'polygon(-25% 50%, 50% 75%, 100% 100%, 100% 60%)',
            }}
        ...
        <div className="mx-auto max-w-2xl py-60 sm:py-48 lg:py-64">
          <div className="text-center">
            <h1 className={`text-5xl font-semibold tracking-tight text-balance ${isDarkMode ? 'text-white' : 'text-gray-900'} sm:text-7xl`}>
              Charming Spell
            </h1>
            <p className={`mt-8 text-lg font-medium text-pretty ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} sm:text-xl/8`}>
        ...
        >
          <div
            style={{
              clipPath:
                'polygon(100% 60%, 100% 100%, 15% 60%, 0% 0%)'
            }}
