  ...
  return (
    ...
    >
      ...
      >
        {/* Левый треугольник */}
        <div
          className={`absolute inset-0 bg-gradient-to-r from-[#ff80b5] to-[#9089fc] opacity-75 animate-triangle-left ${styles['animate-triangle-left']}`}
          style={{
            clipPath: "polygon(0% 0%, 100% 50%, 0% 100%)", // Начальная форма
          }}
        />
      </div>
      ...
      >
        {/* Правый треугольник */}
        <div
          className={`absolute inset-0 bg-gradient-to-l from-[#6ee7b7] to-[#3b82f6] opacity-75 animate-triangle-right ${styles['animate-triangle-right']}`}
          style={{
            clipPath: "polygon(100% 0%, 0% 50%, 100% 100%)", // Начальная форма
          }}
        />
      </div>
